...
type Props = {
  ...
  /** Output resolution — 1920x1080 landscape or 1080x1920 vertical. */
  width?: number;
  height?: number;
...
/**
 * Off-screen, full-resolution mount of the whiteboard used only while
...
export function ExportRenderer({
  ...
  useEffect(() => {
    ...
    return () => onReady(null);
  }, [onReady, timeline, mode, width, height]);
